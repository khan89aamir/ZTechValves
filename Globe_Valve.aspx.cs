...
public partial class Globe_Valve : System.Web.UI.Page
{
    ...
    private void LoadData()
    {
        ...
        DataTable dtProduct = ObjDAL.ExecuteSelectStatement("select * from View_ProductDetails where ProductID=2");
    ...
    private void LoadCarouselRepeater()
    {
        ...
        DataTable dtProduct = ObjDAL.ExecuteSelectStatement("select Path from tblImages where ProductID=2 AND flag=0");
        if (dtProduct.Rows.Count > 0)
        {
