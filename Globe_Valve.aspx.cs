...
public partial class Globe_Valve : System.Web.UI.Page
{
    ...
    private void LoadData()
    {
        ...
        // dont write db_name.dbo.viewname, it doesn't work in my sq. 2 is hardcode for globe which is fixed

        DataTable dtProduct = ObjDAL.ExecuteSelectStatement("SELECT ProductName,ConstFeatures,SizeDetails FROM ztech.View_ProductDetails WHERE ProductID=2");
    ...
    private void LoadCarouselRepeater()
    {
        ...
        DataTable dtProduct = ObjDAL.ExecuteSelectStatement("SELECT Path FROM ztech.tblImages WHERE ProductID=2 AND flag=0");
        if (dtProduct!=null && dtProduct.Rows.Count > 0)
        {
