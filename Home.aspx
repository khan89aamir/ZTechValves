                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text ">
                                <h3><span>BALL VALVE</span> </h3>
                                <p>A ball valve is a shut-off valve that controls<br /> the flow of a liquid or gas by means of a <br />
                                    rotary ball having a bore.<br />
                                    By rotating the ball a quarter turn<br />
            ...
            <div class="single_slider  d-flex align-items-center slider_bg_1">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text ">
                                <h3> <span>GLOBE VALVE</span> <br>
                                    </h3>
                                <p>This design simplifies manufacturing,<br />
                                    installation, and repair. This type<br />
                                    of valve is used where pressure <br />drop is not a concern and<br />
                                    throttling is required.</p>
                        ...
                        <div class="col-xl-12">
                            <div class="slider_text ">
                                <h3> <span>Health care</span> <br>
                                    For Hole Family </h3>
                                <p>In healthcare sector, service excellence<br />
                                    is the facility of the hospital as
                                    healthcare<br /> service provider to consistently.</p>
