...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="card center">
            <img id="SwingCheckValveImg" src="img/Valves/swing_check_Valve.jpg" alt="Paris" class="center">
        <div class="container">
            <center><p style="font-family:'Times New Roman, Times, serif;'">SWING CHECK VALVES </p></center>
        </div>
    </div>
	<br />
...
CF8 M</pre>
   ...
   <br />
    ...
    <div class="card center">
        ...
        <ul class="Mylst">
        <li>Type of Swing Check</li>
        <li>Valve Code BS 1868</li>
        <li>End to End Dimension ANSI B16.10/BS1560</li>
        <li>Cover Bolted</li>
        <li>Disc Hinged</li>
        <li>Seat Seal Welded / Renewable - Screwed</li>
        <li>Testing Code MSS SP 61/BS 6755/API 598</li>
    </ul>
    </div>
    <br/>
