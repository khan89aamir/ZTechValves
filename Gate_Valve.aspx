...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="card center">
        <img id="GateValveImg" src="img/Valves/gate_Valve.jpg" alt="Paris" class="center">
        <div class="container">
            <center><p style="font-family:'Times New Roman, Times, serif;'">GATE VALVES </p></center>
        </div>
    </div>
    <br />
    <div class="card center">
