<%@ Page Language="C#" MasterPageFile="~/ZTechMasterPage.master" AutoEventWireup="true" CodeFile="FORGED_VALVE.aspx.cs" Inherits="FORGED_VALVE" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">

    <link href="css/ProductCSS.css" rel="stylesheet" />

    <%--<center><h1 style="font-family:'Times New Roman, Times, serif;'">FORGED VALVE</h1></center>--%>
